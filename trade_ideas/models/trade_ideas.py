...
class DayAggs(models.Model):
    ...
    def cron_import(self):
        self._import_aggs('polygon/us_stocks_sip/minute_aggs_v1/*/*')
...
class DayAggs(models.Model):
    ...
    # COPY day_aggs(ticker,volume,open,close,high,low,window_start,transactions) FROM PROGRAM 'gzip -dc polygon/2020-07-06.csv.gz' DELIMITER ',' CSV HEADER NULL '';


    def cron_import(self):
        self._import_aggs('polygon/us_stocks_sip/day_aggs_v1/*/*')
